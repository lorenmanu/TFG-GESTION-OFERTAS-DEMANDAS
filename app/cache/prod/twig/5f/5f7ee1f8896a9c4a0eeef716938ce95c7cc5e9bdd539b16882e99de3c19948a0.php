...
class __TwigTemplate_32e84c9510f854e639395116e65e9b341d3edc53247732bd656cd30ed0e9d67a extends Twig_Template
{
    ...
    public function block_cuerpo($context, array $blocks = array())
    {
        ...
        if (((twig_first($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? null), "security", array()), "getToken", array(), "method"), "getUser", array(), "method"), "roles", array())) == "ROLE_SUPER_ADMIN") || ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? null), "security", array()), "getToken", array(), "method"), "getUser", array(), "method"), "getUsername", array(), "method") == $this->getAttribute(($context["oferta"] ?? null), "getAutor", array(), "method")))) {
            ...
            echo "                        <br>
                        ...
                        ";
            // line 13
            if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? null), "security", array()), "getToken", array(), "method"), "getUser", array(), "method"), "getUsername", array(), "method") == $this->getAttribute(($context["oferta"] ?? null), "getAutor", array(), "method"))) {
                // line 14
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("editOferta", array("idOferta" => $this->getAttribute(($context["oferta"] ?? null), "id", array()))), "html", null, true);
            ...
            echo "                      <hr>
                        <h3><small> Oferta de ";
            // line 25
            echo twig_escape_filter($this->env, $this->getAttribute(($context["oferta"] ?? null), "getAutor", array(), "method"), "html", null, true);
            echo " </small></h3>
        ...
        // line 30
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute(($context["oferta"] ?? null), "fechaInicio", array()), "Y-m-d"), "html", null, true);
        echo "</li>
                      <li class=\"list-group-item list-group-item-info liInfo\">Fecha Fin: ";
        // line 31
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute(($context["oferta"] ?? null), "fechaFin", array()), "Y-m-d"), "html", null, true);
        echo "</li>
                    </ul>
                    <hr>
                </div>
        ...
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["oferta"] ?? null), "getBrochure", array(), "method"), "html", null, true);
        echo "\" alt=\"Example\" />
                      </div>
                      <div class=\"col-xs-6 col-sm-8 col-md-8 col-lg-8\">
                        ...
                        <article class=\"descripcionItem\">
                          <p>
                            ";
        // line 48
        echo twig_escape_filter($this->env, $this->getAttribute(($context["oferta"] ?? null), "getDescripcion", array(), "method"), "html", null, true);
        echo "  ";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["oferta"] ?? null), "getId", array(), "method"), "html", null, true);
        echo "
                            </p>
                         </article>
                    </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["anio"]) {
            // line 60
            echo "                            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("mostrarOferta", array("idAnio" => $this->getAttribute($context["anio"], "id", array()), "idOferta" => $this->getAttribute(($context["oferta"] ?? null), "getId", array(), "method"))), "html", null, true);
            echo "\">Visitas Año ";
        ...
        // line 105
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["oferta"] ?? null), "getComentarios", array(), "method"));
                             ...
                             <div class=\"modal-content\">
                               ...
                               <div class=\"modal-body\">
                                 ...
                                 <div class=\"modal-footer \">
                                   <a href=\"";
            // line 129
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("eliminarComentario", array("idComentario" => $this->getAttribute($context["comentario"], "id", array()), "tipoItem" => ($context["oferta"] ?? null), "idItem" => $this->getAttribute(($context["oferta"] ?? null), "id", array()))), "html", null, true);
        ...
        if (array_key_exists("formContactAutor", $context)) {
            ...
            echo "
                            ";
            // line 164
            echo             $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->renderBlock(($context["formContactAutor"] ?? null), 'form_start', array("action" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("mostrarOferta", array("id" => $this->getAttribute(($context["oferta"] ?? null), "id", array()))), "method" => "POST"));
            echo "
                      ...
                      <div class=\"row\">
                        <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                          <div class=\"col-lg-6 col-md-6 col-sm-6 col-xs-6\">
                            <a href=\"";
        // line 196
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("eliminarOferta", array("idOferta" => $this->getAttribute(($context["oferta"] ?? null), "id", array()), "resolve" => "si")), "html", null, true);
        echo "\">
                          ...
                          <div class=\"col-lg-6 col-md-6 col-sm-6 col-xs-6\">
                            <a href=\"";
        // line 201
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("eliminarOferta", array("idOferta" => $this->getAttribute(($context["oferta"] ?? null), "id", array()), "resolve" => "no")), "html", null, true);
        echo "\">
  ...
  ";
    ...
    {
        return new Twig_Source("", "OfertaBundle:Default:oferta.html.twig", "/home/ubuntu/Escritorio/todo/TFG-LRR2/src/OfertaBundle/Resources/views/Default/oferta.html.twig");
    }
}
