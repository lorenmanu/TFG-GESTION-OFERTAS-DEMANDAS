...
class __TwigTemplate_f1193cde73818fc2ef86a7d526ca03455fcc62fcbfd99be33786f0b43fc85fb6 extends Twig_Template
{
    ...
    {
        $__internal_686708d1c6b482f68e9478bc7aafd2b9102d8fa15a467adc6364cd4b40687670 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_686708d1c6b482f68e9478bc7aafd2b9102d8fa15a467adc6364cd4b40687670->enter($__internal_686708d1c6b482f68e9478bc7aafd2b9102d8fa15a467adc6364cd4b40687670_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "OfertaBundle:Default:menu.html.twig"));
...
";
        ...
        $__internal_686708d1c6b482f68e9478bc7aafd2b9102d8fa15a467adc6364cd4b40687670->leave($__internal_686708d1c6b482f68e9478bc7aafd2b9102d8fa15a467adc6364cd4b40687670_prof);
    ...
    {
        return array (  144 => 51,  136 => 49,  131 => 48,  127 => 47,  120 => 42,  116 => 40,  108 => 37,  100 => 34,  89 => 31,  86 => 30,  82 => 29,  79 => 28,  75 => 26,  71 => 24,  69 => 23,  63 => 22,  59 => 20,  55 => 19,  47 => 16,  43 => 14,  39 => 13,  36 => 12,  34 => 11,  22 => 1,);
    }
      ...
      <ul class=\"treeview-menu\">
        <li class=\"treeview\">
          ...
          {% if  areas is defined and tipos is defined %}
            <ul class=\"treeview-menu\">
              {% for area in areas %}
                <li id=\"liArea\">
                  <i class=\"fa fa-circle-o\" id=\"circleArea\"></i>
                  <a id=\"enlace\" href=\"{{ path('mostrarOfertas', {'area_id': area.id}) }}\"> {{ area.getNombre() }}</a>
                  <a id=\"mostrarOpciones\"><i id=\"flecha\" class=\"fa fa-angle-left pull-right\"> </i></a>
                  <ul class=\"treeview-menu\">
                    {% for rama in area.getRamas()  %}
                      <li id=\"liArea\">
                        <i class=\"fa fa-circle-o\" id=\"circleArea\"></i>
                        <a id=\"enlace\" href=\"{{ path('mostrarOfertas', { 'area_id': area.id ,'rama_id': rama.id}) }}\"> {{ rama.getNombre() }}</a>
                        {% if rama.getDisciplinas()|length > 0 %}
                          <a id=\"mostrarOpciones\"><i id=\"flecha\" class=\"fa fa-angle-left pull-right\"> </i></a>
                        {% else %}
                          <a id=\"mostrarOpciones\"></a>
                        {% endif %}
                        <ul class=\"treeview-menu\">
                          {% for disciplina in rama.getDisciplinas()  %}
                            <li id=\"liArea\">
                              <a href=\"{{ path('mostrarOfertas', {'area_id': area.id,'rama_id': rama.id, 'disciplina_id': disciplina.id}) }}\"><i class=\"fa fa-circle-o\"></i> {{ disciplina.getNombre() }} </a>
                            </li>
                          {% endfor %}
                        </ul>
                      </li>
          ...
          <li class=\"treeview\">
            ...
            <ul class=\"treeview-menu\">
              {% for tipo in tipos %}
                <li><a href=\"{{ path('mostrarOfertas', {'tipo': tipo.id}) }}\"><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i>
 {{ tipo.getNombre() }} </a></li>
              {% endfor %}
            </ul>
          </li>
