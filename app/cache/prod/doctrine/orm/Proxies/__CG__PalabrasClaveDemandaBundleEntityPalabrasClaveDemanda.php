...
namespace Proxies\__CG__\PalabrasClaveDemandaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class PalabrasClaveDemanda extends \PalabrasClaveDemandaBundle\Entity\PalabrasClaveDemanda implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PalabrasClaveDemandaBundle\\Entity\\PalabrasClaveDemanda' . "\0" . 'id', '' . "\0" . 'PalabrasClaveDemandaBundle\\Entity\\PalabrasClaveDemanda' . "\0" . 'palabrasClave', '' . "\0" . 'PalabrasClaveDemandaBundle\\Entity\\PalabrasClaveDemanda' . "\0" . 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PalabrasClaveDemanda $proxy) {
