...
namespace Proxies\__CG__\RegistroVisitasDemandaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class RegistroVisitasDemanda extends \RegistroVisitasDemandaBundle\Entity\RegistroVisitasDemanda implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RegistroVisitasDemandaBundle\\Entity\\RegistroVisitasDemanda' . "\0" . 'id', '' . "\0" . 'RegistroVisitasDemandaBundle\\Entity\\RegistroVisitasDemanda' . "\0" . 'visitasDia', '' . "\0" . 'RegistroVisitasDemandaBundle\\Entity\\RegistroVisitasDemanda' . "\0" . 'vistasMes', '' . "\0" . 'RegistroVisitasDemandaBundle\\Entity\\RegistroVisitasDemanda' . "\0" . 'demanda', '' . "\0" . 'RegistroVisitasDemandaBundle\\Entity\\RegistroVisitasDemanda' . "\0" . 'visitasAnio'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistroVisitasDemanda $proxy) {
    ...
    public function setDemanda(\DemandaBundle\Entity\Demanda $demanda = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDemanda', [$demanda]);

        return parent::setDemanda($demanda);
    }
    ...
    public function getDemanda()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDemanda', []);

        return parent::getDemanda();
    }
