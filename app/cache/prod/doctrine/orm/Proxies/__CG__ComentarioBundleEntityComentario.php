...
class Comentario extends \ComentarioBundle\Entity\Comentario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ComentarioBundle\\Entity\\Comentario' . "\0" . 'id', '' . "\0" . 'ComentarioBundle\\Entity\\Comentario' . "\0" . 'autor', '' . "\0" . 'ComentarioBundle\\Entity\\Comentario' . "\0" . 'fecha', '' . "\0" . 'ComentarioBundle\\Entity\\Comentario' . "\0" . 'contenido'];
        }
