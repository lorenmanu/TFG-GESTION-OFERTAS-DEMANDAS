...
namespace Proxies\__CG__\PalabrasClaveOfertaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class PalabrasClaveOferta extends \PalabrasClaveOfertaBundle\Entity\PalabrasClaveOferta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PalabrasClaveOfertaBundle\\Entity\\PalabrasClaveOferta' . "\0" . 'id', '' . "\0" . 'PalabrasClaveOfertaBundle\\Entity\\PalabrasClaveOferta' . "\0" . 'palabrasClave', '' . "\0" . 'PalabrasClaveOfertaBundle\\Entity\\PalabrasClaveOferta' . "\0" . 'usuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PalabrasClaveOferta $proxy) {
