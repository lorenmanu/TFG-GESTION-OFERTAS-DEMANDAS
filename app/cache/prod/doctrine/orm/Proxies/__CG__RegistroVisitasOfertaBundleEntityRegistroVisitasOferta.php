...
namespace Proxies\__CG__\RegistroVisitasOfertaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class RegistroVisitasOferta extends \RegistroVisitasOfertaBundle\Entity\RegistroVisitasOferta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RegistroVisitasOfertaBundle\\Entity\\RegistroVisitasOferta' . "\0" . 'id', '' . "\0" . 'RegistroVisitasOfertaBundle\\Entity\\RegistroVisitasOferta' . "\0" . 'visitasDia', '' . "\0" . 'RegistroVisitasOfertaBundle\\Entity\\RegistroVisitasOferta' . "\0" . 'vistasMes', '' . "\0" . 'RegistroVisitasOfertaBundle\\Entity\\RegistroVisitasOferta' . "\0" . 'oferta', '' . "\0" . 'RegistroVisitasOfertaBundle\\Entity\\RegistroVisitasOferta' . "\0" . 'visitasAnio'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistroVisitasOferta $proxy) {
