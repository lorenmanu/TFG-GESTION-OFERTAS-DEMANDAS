...
namespace Proxies\__CG__\VisitasAnioBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class VisitasAnio extends \VisitasAnioBundle\Entity\VisitasAnio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'VisitasAnioBundle\\Entity\\VisitasAnio' . "\0" . 'id', '' . "\0" . 'VisitasAnioBundle\\Entity\\VisitasAnio' . "\0" . 'anio', '' . "\0" . 'VisitasAnioBundle\\Entity\\VisitasAnio' . "\0" . 'visitas', '' . "\0" . 'VisitasAnioBundle\\Entity\\VisitasAnio' . "\0" . 'visitasMes'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VisitasAnio $proxy) {
    ...
    public function addVisitasMe(\VisitasMesBundle\Entity\VisitasMes $visitasMe)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addVisitasMe', [$visitasMe]);

        return parent::addVisitasMe($visitasMe);
    }
    ...
    public function removeVisitasMe(\VisitasMesBundle\Entity\VisitasMes $visitasMe)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeVisitasMe', [$visitasMe]);

        return parent::removeVisitasMe($visitasMe);
    }
