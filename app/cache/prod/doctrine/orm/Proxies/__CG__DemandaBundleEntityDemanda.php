...
class Demanda extends \DemandaBundle\Entity\Demanda implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'id', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'nombre', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'autor', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'descripcion', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'condiciones', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'fechaInicio', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'fechaFin', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'contacto', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'brochure', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'comentarios', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'area', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'rama', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'disciplina', '' . "\0" . 'DemandaBundle\\Entity\\Demanda' . "\0" . 'tipo'];
        }
